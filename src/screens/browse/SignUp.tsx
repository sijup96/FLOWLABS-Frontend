...
const SignUp = () => {
  ...
  useEffect(() => {
    ...
    else setIsOtpResendAllowed(true);
    return () => {
  ...
  const handleVerify = async (
    ...
    try {
      ...
      setOtpInput(true);
      setOtpTimer(30);
      if (isOtpResendAllowed) setIsOtpResendAllowed(false);
    } catch (error) {
  ...
  const handleInput = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    switch (name) {
      case "companyName":
        errorMessage = fieldValidation.companyName(value)
          ? ""
        ...
        break;
      case "phone":
        errorMessage = fieldValidation.phone(Number(value))
          ? ""
          : "Invalid phone number";
        setError((prevState) => ({ ...prevState, phoneError: errorMessage }));
        break;
      case "email":
        errorMessage = fieldValidation.email(value)
          ? ""
      ...
      <div className="flex flex-col md:flex-row justify-around items-center bg-gradient-to-r flex-grow from-gray-700 via-gray-900 to-black text-white py-10 bg-gray-600">
        <div className="p-6 md:p-10 max-w-lg text-center md:text-left">
          <h1 className="font-extrabold text-3xl md:text-4xl mb-4">
            Lead with data, manage with ease, and <br /> inspire your team with
            FlowLabs.
          </h1>
          <div className="pl-3 mt-6">
            <ul className="list-disc space-y-3">
              ...
              <li className="text-lg font-semibold">
                Innovative Features for the Modern Workplace
              </li>
              <li className="text-lg font-semibold">
                Dedicated Support and Comprehensive Training
              </li>
              <li className="text-lg font-semibold">
        ...
        {!isSignedUp ? (
            ...
            <form className="space-y-6">
              ...
              {otpInput && (
                <div>
                  ...
                  />
                  {error.otpError && (
                    <span className="text-red-600 font-bold text-sm pl-3">
                      {error.otpError}
                    </span>
                  )}
          ...
          <div className="flex flex-col items-center justify-center p-6 border border-gray-300 rounded-lg w-80 mx-auto bg-gray-600">
            <div className="p-4">
              <Icons.checkCircle className="text-green-500 w-16 h-16 " />
            </div>
            ...
            <p className="text-center mb-4">
              Login details have been sent to:{" "}
              <strong>Your registerd email.</strong>
            </p>
          </div>
        )}
      </div>
