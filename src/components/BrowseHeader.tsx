...
<div className='flex justify-between items-center p-4 bg-white shadow-md'>
  <div className='text-gray-700 font-extrabold text-xl sm:text-2xl cursor-pointer' onClick={()=>navigate('/')}>
    <h1>FLOW LABS</h1>
  </div>
  ...
  {/* Menu Items */}
  <div className={`flex-col sm:flex-row sm:space-x-5 text-gray-700 ${isOpen ? 'flex' : 'hidden'} sm:flex`}>
